...
# Currently unused; variant processing is disabled in config/application.rb. Re-enable with
# ruby-vips (>= 2.2.1) + libvips when attachments need transforms (Active Storage 8.1.3.1+ / CVE-2026-66066).
