# Manual validation: vegas_handicap

**Format:** Vegas (2v2 wash)  
**Scenario:** Net cap applies before digit pairing (gross 8 and 10 cap to 9)  
...
|---|---|---|---|---|---|---|---|---|
| 1 | 4 | 8/9 | 89 | 5/6 | 56 | — | -33 | -33 |

**Result: Team B leads by 33** (margin -33, from Team A's perspective)
